...
void vulkan_framebuffer_create(
    ...
    out_framebuffer->attachments = pancake_allocate(sizeof(VkImageView) * attachment_count, MEMORY_TAG_RENDERER);
...
void vulkan_framebuffer_destroy(vulkan_context* context, vulkan_framebuffer* framebuffer) {
    ...
    if (framebuffer->attachments) {
        pancake_free(framebuffer->attachments, sizeof(VkImageView) * framebuffer->attachment_count, MEMORY_TAG_RENDERER);
